      ...
      <div className="relative z-10">
        ...
        <div className="flex">
          <button
            ...
            className="mt-[1.5rem] flex-1 px-4 py-3 disabled:cursor-not-allowed disabled:bg-gray-400 font-bold bg-[#2ECC71] text-white rounded-md hover:bg-[#1abc9c] transition-colors"
          >
            Register Now
          </button>
        </div>
